        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            <section>
              ...
              <p className="mt-4">
                We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by support@ednoteai.com, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
              </p>
              <p className="mt-4">
            ...
            <section>
              ...
              <ol className="list-decimal pl-6 space-y-1">
                <li><a href="#our-services" className="text-primary hover:underline">OUR SERVICES</a></li>
                <li><a href="#intellectual-property-rights" className="text-primary hover:underline">INTELLECTUAL PROPERTY RIGHTS</a></li>
                <li><a href="#user-representations" className="text-primary hover:underline">USER REPRESENTATIONS</a></li>
                <li><a href="#user-registration" className="text-primary hover:underline">USER REGISTRATION</a></li>
                <li><a href="#purchases-and-payment" className="text-primary hover:underline">PURCHASES AND PAYMENT</a></li>
                <li><a href="#subscriptions" className="text-primary hover:underline">SUBSCRIPTIONS</a></li>
                <li><a href="#prohibited-activities" className="text-primary hover:underline">PROHIBITED ACTIVITIES</a></li>
                <li><a href="#user-generated-contributions" className="text-primary hover:underline">USER GENERATED CONTRIBUTIONS</a></li>
                <li><a href="#contribution-license" className="text-primary hover:underline">CONTRIBUTION LICENSE</a></li>
                <li><a href="#guidelines-for-reviews" className="text-primary hover:underline">GUIDELINES FOR REVIEWS</a></li>
                <li><a href="#services-management" className="text-primary hover:underline">SERVICES MANAGEMENT</a></li>
                <li><a href="#privacy-policy" className="text-primary hover:underline">PRIVACY POLICY</a></li>
                <li><a href="#term-and-termination" className="text-primary hover:underline">TERM AND TERMINATION</a></li>
                <li><a href="#modifications-and-interruptions" className="text-primary hover:underline">MODIFICATIONS AND INTERRUPTIONS</a></li>
                ...
                <li><a href="#corrections" className="text-primary hover:underline">CORRECTIONS</a></li>
                <li><a href="#disclaimer" className="text-primary hover:underline">DISCLAIMER</a></li>
                <li><a href="#limitations-of-liability" className="text-primary hover:underline">LIMITATIONS OF LIABILITY</a></li>
                <li><a href="#indemnification" className="text-primary hover:underline">INDEMNIFICATION</a></li>
                <li><a href="#user-data" className="text-primary hover:underline">USER DATA</a></li>
                <li><a href="#electronic-communications" className="text-primary hover:underline">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
                <li><a href="#california-users" className="text-primary hover:underline">CALIFORNIA USERS AND RESIDENTS</a></li>
                <li><a href="#miscellaneous" className="text-primary hover:underline">MISCELLANEOUS</a></li>
            ...
            <section id="intellectual-property-rights">
              ...
              <h3 className="text-lg font-semibold mb-2 mt-6">Your use of our Services</h3>
              <p>
              ...
              <p className="mt-4">
                If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: support@ednoteai.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
              </p>
              <p className="mt-4">
              ...
              <h3 className="text-lg font-semibold mb-2 mt-6">Your submissions</h3>
              <p>
                Please review this section and the "PROHIBITED ACTIVITIES" section carefully prior to using our Services to understand the (a) rights you give us and obligations you have when you post or upload any content through the Services.
              </p>
              <p className="mt-4">
            ...
            <section id="subscriptions">
              ...
              <h3 className="text-lg font-semibold mb-2">Billing and Renewal</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold mb-2 mt-4">Cancellation</h3>
              <p>
                All purchases are non-refundable. You can cancel your subscription at any time by logging into your account. Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please email us at support@ednoteai.com.
              </p>

              <h3 className="text-lg font-semibold mb-2 mt-4">Fee Changes</h3>
              <p>
            ...
            <section id="prohibited-activities">
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2">
                ...
                <li>Trick, defraud, or mislead us and other users, especially in an attempt to learn sensitive account information such as user passwords.</li>
            ...
            <section id="user-generated-contributions">
              ...
              <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <li>You are the creator and owner of or have the necessary licenses, rights, consents, releases, permissions to use and to authorize us, the Services, and other users of the Services to use your Contributions in any manner contemplated by the Services and these Legal Terms.</li>
            ...
            <section id="guidelines-for-reviews">
              <h2 className="text-2xl font-semibold mb-4">10. GUIDELINES FOR REVIEWS</h2>
              <p>
              ...
              <p className="mt-4">
                We may accept, reject, or remove reviews in our sole discretion. We have absolutely no obligation to screen reviews or to delete reviews, even if anyone considers reviews objectionable or inaccurate. Reviews are not endorsed by us, and do not necessarily represent our opinions or the views of any of our affiliates or partners. We do not assume liability for any reviewer for any claims, liabilities, or losses resulting from any review. By posting review, you hereby grant to us a perpetual, non-exclusive, worldwide, royalty-free, fully paid, assignable, and sublicensable right and license to reproduce, modify, translate, transmit by any means, display, perform, and/or distribute all content relating to review.
              </p>
            </section>
            ...
            <section id="modifications-and-interruptions">
              <h2 className="text-2xl font-semibold mb-4">14. MODIFICATIONS AND INTERRUPTIONS</h2>
              <p>
            ...
            <section id="dispute-resolution">
              ...
              <h3 className="text-lg font-semibold mb-2 mt-4">Binding Arbitration</h3>
              <p>
              ...
              <p className="mt-4">
                If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Cook County, Illinois, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non convenient with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.
              </p>
              <p className="mt-4">
                In no event shall any Dispute brought by either Party related in any way to the Services be commenced more than one (1) years after the cause of action arose. If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.
              </p>

              <h3 className="text-lg font-semibold mb-2 mt-4">Restrictions</h3>
              <p>
                The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.
              </p>

              <h3 className="text-lg font-semibold mb-2 mt-4">Exceptions to Informal Negotiations and Arbitration</h3>
              <p>
            ...
            <section id="corrections">
              <h2 className="text-2xl font-semibold mb-4">17. CORRECTIONS</h2>
              <p>
            ...
            <section id="limitations-of-liability">
              <h2 className="text-2xl font-semibold mb-4">19. LIMITATIONS OF LIABILITY</h2>
              <p>
            ...
            <section id="indemnification">
              <h2 className="text-2xl font-semibold mb-4">20. INDEMNIFICATION</h2>
              <p>
            ...
            <section id="user-data">
              <h2 className="text-2xl font-semibold mb-4">21. USER DATA</h2>
              <p>
            ...
            <section id="electronic-communications">
              <h2 className="text-2xl font-semibold mb-4">22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
              <p>
